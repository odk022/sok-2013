...
Kommentar:\
Trade Openness måler hvor stor andel summen av eksport og import utgjør av bruttonasjonalproduktet i et land. Tabellen viser data for en del utvalgte land. Land der verdier mangler, er tatt ut. Den siste kolonnen - trade_openness - er i prosent. Tabellen viser at det er store forskjeller i trade openness mellom land. Vi ser for eksempel at det første landet i tabellen, Argentina, utgjør eksport og import relativt liten andel av bruttonasjonalprodukt, mens for Irland(IRL) lenger ned i tabellen utgjør eksport og import i perioden 2018-2022 rundt det dobbelte av bruttonasjonalproduktet.
